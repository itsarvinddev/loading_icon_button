...
///
/// Due to logical conflicts, the [OutlinedLoadingButton.loadingClickable] parameter cannot be used in the automatic management button,
/// If you need to use it, please use [OutlinedLoadingButton] yourself.
///
...
///
/// [style] Please refer to [OutlinedButton.styleFrom] for generation
